...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.trimesh_option = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.mnmesh_option = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.add_shell_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.shell_offset = QtWidgets.QDoubleSpinBox(self.layoutWidget1)
        ...
        self.add_edit_mesh_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.collapse_modifier_stack_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.center_pivot_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
        self.center_pivot_checkbox.setObjectName("center_pivot_checkbox")
        self.verticalLayout.addWidget(self.center_pivot_checkbox)
        self.delete_original_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtWidgets.QApplication.translate("Form", "Explode Geometry", None))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("Form", "Explode Options", None))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("Form", "Geometry Type", None))
        self.trimesh_option.setText(QtWidgets.QApplication.translate("Form", "TriMesh", None))
        self.mnmesh_option.setText(QtWidgets.QApplication.translate("Form", "MNMesh", None))
        self.add_shell_checkbox.setText(QtWidgets.QApplication.translate("Form", "Add Shell Modifier    ---->", None))
        self.offset_label.setText(QtWidgets.QApplication.translate("Form", "Offset:", None))
        self.add_edit_mesh_checkbox.setText(QtWidgets.QApplication.translate("Form", "Add Edit Mesh Modifier", None))
        self.collapse_modifier_stack_checkbox.setText(QtWidgets.QApplication.translate("Form", "Collapse Modifier Stack", None))
        self.center_pivot_checkbox.setText(QtWidgets.QApplication.translate("Form", "Center Pivot", None))
        self.delete_original_checkbox.setText(QtWidgets.QApplication.translate("Form", "Delete Original", None))
        self.select_label.setText(QtWidgets.QApplication.translate("Form", "Selected Object(s):", None))
        self.selected_objects_string.setText(QtWidgets.QApplication.translate("Form", "None", None))
        self.explode_button.setText(QtWidgets.QApplication.translate("Form", "Explode", None))



''' Form class that allows the user to select options for the script
'''
class Form(QtWidgets.QDialog, Ui_Form):
